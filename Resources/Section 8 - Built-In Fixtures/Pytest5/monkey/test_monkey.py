...
def test_env(monkeypatch):
    monkeypatch.setenv('HOME', '/Users/patyay')
    assert os.environ['HOME'] == '/Users/petyay'


def test_prepend(monkeypatch):
    monkeypatch.setenv('PATH', '/Users/martinyanev/bin', ':')
    assert os.environ['PATH'].startswith('/Users/martinyanev/bin')
